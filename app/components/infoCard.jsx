    ...
    <div className={styles.infoCard}>
      <div className={styles.infoCardComponent}>
        <div className={styles.infoCardImageComponent}>
          <div className={styles.infoCardBannerImage}>
            ...
            <button
              type="button"
              onClick={() => showRentals(InfoCardTitle)}
        ...
        <div className={styles.infoCardTextComponent}>
          ...
          <div className={styles.moreInfoHeight}>
            ...
            {InfoCardRules.length > 0 && (
              <div className={styles.otherInfoCardArea}>
                <h1>Rules</h1>
                <ol>
                  {Array.isArray(InfoCardRules) &&
                    InfoCardRules.map((info) => <li key={info}>{info}</li>)}
                </ol>
              </div>
            )}
          </div>
      ...
      <div className={styles.infoCardFooter}>
        ...
        <div className={styles.infoCardFooterWrapper}>
          ...
          {InfoCardPayable.length > 0 && (
            <div className={styles.infoCardFooterCinB}>
              <h1>Payeables</h1>
              {Array.isArray(InfoCardPayable) &&
                InfoCardPayable.map((i, index) => (
                  <div key={index} className={styles.infoCardTableS}>
                    <h3>{i.title}</h3>
                    <h3>{i.description}</h3>
                  </div>
